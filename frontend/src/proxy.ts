...
export function proxy(request: NextRequest) {
    ...
    img-src 'self' blob: data: https://maketicket.app https://*.maketicket.app https://*.googleusercontent.com http://localhost:5000 https://rickandmortyapi.com https://image.pollinations.ai;
